...
const Sidebar = () => {
    ...
    return (
        <div
          ...
          shadow-2x1 md:w-[35vw] xl:max-w-[30w] transition-all 
        ...
        >
            ...
            <div className=" flex flex-col gapy3 py-4 mt-4">
                <div className=" flex w-full justify-between items-center">
                    ...
                    <div
                      ...
                      text-white w-12 h-12 flex justify-center items-center text-x1"
                    >
                        <FiTrash2 />
                    </div>
                </div>
                <Link to={'/'} className='bg-gray-200 flex p-4 justify-center items-center text-primary w-full font-medium mt-4 mb-4'>View cart</Link>
